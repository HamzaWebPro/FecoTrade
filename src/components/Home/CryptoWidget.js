  ...
  return (
    ...
    <section className="bg-light py-5">
            ...
            <div className="container">
                ...
                <div className="">
                <div className="binance-widget-marquee " data-cmc-ids="1,1027,1839,52,3408,74,5426,3890,5805,7083" data-theme="light" data-transparent="false" data-locale="en" data-powered-by="Powered by" data-disclaimer="Disclaimer" ></div>
                </div>
                {/* <div className="row">
