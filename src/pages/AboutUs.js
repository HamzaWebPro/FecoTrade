                        ...
                        <div className="row about-bx2 style-1 align-items-center">
                            ...
                            <div className="col-lg-6 about-content ps-lg-5 m-b30">
                                <div className="section-head">
                                    ...
                                    <p className="m-0 lh-base">FundexPro is affordable and easy-to-use cloud mining service. We have the cheapest source of renewable electricity in the world. If you’re looking to mine Crypto asset, FundexPro is the greatest choice, allowing you to mine cryptocurrencies without owning any equipment.
                                    </p>
                                </div>
                                <div>
                                    <ul>
